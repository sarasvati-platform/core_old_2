...
import { noteTypeFieldsSteps } from '@tests/features/flashcards/steps/note-type/note-field.steps'
...
autoBindSteps([
  ...
  loadFeature('features/flashcards/note-type/note-field.feature'),
